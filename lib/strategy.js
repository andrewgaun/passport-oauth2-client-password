...
function Strategy(options, verify) {
  ...
  this._clientIdField = options.clientIdField || 'client_id';
  this._clientSecretField = options.clientSecretField || 'client_secret';
...
Strategy.prototype.authenticate = function(req) {
  if (!req.body || (!req.body[this._clientIdField] || !req.body[this._clientSecretField])) {
    return this.fail();
  }
